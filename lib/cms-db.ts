...
const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS website_requests (
    ...
    page_area TEXT NOT NULL DEFAULT '',
    ...
    created_at TEXT NOT NULL DEFAULT (datetime('now')),
    updated_at TEXT NOT NULL DEFAULT (datetime('now')),
    FOREIGN KEY(requested_by_user_id) REFERENCES cms_users(id),
    FOREIGN KEY(closed_by_user_id) REFERENCES cms_users(id)
  )`,
  `CREATE TABLE IF NOT EXISTS website_request_events (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    ...
    created_at TEXT NOT NULL DEFAULT (datetime('now')),
    FOREIGN KEY(request_id) REFERENCES website_requests(id)
  )`,
